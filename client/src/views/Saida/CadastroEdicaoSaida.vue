                ...
                <div class="card-body" style="padding-top:35px; padding-bottom:30px;">
                    <ValidationForm :model="saida" ref="validation" @save="salvar(saida)">
                        ...
                        <div class="form-group col-10" style="display: flex; margin-top:10px">
                            ...
                            <div class="col-4" >
                                <select v-model="saida.depositoId" id="select-deposito" class="form-control">
                                    <option value=""></option> 
                        ...
                        <div class="form-group col-10" style="display: flex; margin-top:10px">
                            ...
                            <div class="col-4" >
                                <select v-model="saida.materialId" id="select-material" class="form-control" v-on:change="carregarUnidade()">
                                    <option value=""></option> 
                        ...
                        <div class="form-group col-10" style="display: flex; margin-top: 10px;">
                            ...
                            <div class="col-4" >
                                <div class="input-group mb-3" style="display: flex;  margin-bottom: 0 !important;">
                                    ...
                                    <input type="number" id="quantidade" class="form-control" v-model="saida.quantidade" min="0">
                                </div> 
                        ...
                        <div id="actionButtons" style="margin-top:50px">
                            ...
                            <button type="submit" id="btn-salvar-saida" class="btn btn-success primaryColorBtn">Salvar</button>
