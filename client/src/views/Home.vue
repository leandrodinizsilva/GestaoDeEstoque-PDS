<template>
  ...
  <div style="margin: auto;  width: 50%;  padding: 10px;">
    <div style="width: 700px!important;height: 500px!important;">
      <h2 style="text-align: center; margin-bottom:20px">Material Por Tempo</h2>
      <div id="dropdownsDepositoMaterial" style="display:flex; justify-content:center;margin-bottom: 25px; margin: auto;  width: 100%;">
          <div class="form-group col-10" style="display: flex; margin-top:10px;">
            <label class="col-2">Depósito</label>
            <div class="col-4" >
                <select v-model="depositoSelecionado" class="form-control" v-on:change="carregarRelatorioMaterialPorTempo()">
                    <option value=""></option> 
            ...
            <div class="col-4" >
                <select v-model="materialSelecionado" class="form-control" v-on:change="carregarRelatorioMaterialPorTempo()">
                    <option value=""></option> 
...
export default {
  ...
  methods:{ 
    ...
    carregarRelatorioMaterialPorTempo(){
      this.axios.post('deposito/carregarRelatorioMaterialPorTempo', {"depositoId": this.depositoSelecionado, "materialId": this.materialSelecionado }  ).then((result) => {
