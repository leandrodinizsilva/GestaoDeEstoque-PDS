...
class EntradaRepositorio{
    ...
    index(usuarioId){
        var sql = "select E.id as id, E.data as data, E.quantidade as quantidade, M.nome as nomeMaterial, D.nome as nomeDeposito, U.nome as nomeUnidade from Entrada as E left join Material as M on M.id = E.materialId left join Deposito as D on D.id = E.depositoId left join Unidade as U on M.unidadeId = U.id where E.usuarioId = ? ORDER BY E.data DESC "
